...
Admin:
	...
	"Zarządzanie kontami rodziców", -> get post put delete
	"Zarządzanie klasami", -> get post put delete
	"Przypisz uczniów do odpowiedniej klasy",
	"Zarządzaj przedmiotami", -> get post put delete
	"Zardządzanie sesjami", -> get post put delete
